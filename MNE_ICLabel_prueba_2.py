...
# Carga un archivo de ejemplo de datos EEG disponible en MNE filtrada entre 0 y 40 Hz.
...
# print(raw.info) # Imprime la información del objeto Raw, que incluye detalles sobre los canales, la frecuencia de muestreo, etc.
...
#dicw = raw.info['ICA'] # Obtiene el diccionario de información ICA del objeto Raw
...
# para cargar las matrices de un archivo CSV
# import pandas as pd
# ica._mixing = pd.read_csv(r"C:\Users\paula\OneDrive\Escritorio\Portables\eeg_wavelet\wICASSO\sub-CTR001_ses-V0_task-CE_desc-wavelet_eeg_wICAsso_mixing.csv", header=None).values
# #ica._mixing = dicw['A']  # matriz de mezcla (inversa)
# ica._unmixing = pd.read_csv(r"C:\Users\paula\OneDrive\Escritorio\Portables\eeg_wavelet\wICASSO\sub-CTR001_ses-V0_task-CE_desc-wavelet_eeg_wICAsso_unmixing.csv", header=None).values
...
label_ica_components(raw, ica, True, False)
